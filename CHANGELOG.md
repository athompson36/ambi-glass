...
- **AmbiIRverb plugin integration** (2025-11-11)
  - Integrated AmbiIRverb JUCE plugin source code
  - Added IR reverb audition UI (IRTestView, IRTestHost)
  - Integrated reverb presets (.ambipreset files)
  - Added plugin documentation and build instructions
  - Updated architecture and UI documentation
