...
Professional ambisonic capture and processing app for 4‑channel Ambi‑Alice microphones. Features real-time A→B conversion, IR measurement, loopback calibration, multi-format export, and integrated reverb processing with **AmbiIRverb** plugin support.

## Features

### Core AmbiGlass Features
...
- ✅ **IR Reverb Audition**: Built-in SwiftUI view for testing impulse responses
- ✅ **JUCE Plugin Source**: Complete AmbiIRverb plugin source code (VST3/AU)
- ✅ **Hybrid Reverb Engine**: Convolution + algorithmic reverb (Spring, Plate, Room, Hall)
- ✅ **Preset Support**: Load and save `.ambipreset` files
- ✅ **Plugin Documentation**: Comprehensive docs in `Plugins/AmbiIRverb/docs/`
...
- **[AmbiIRverb Plugin](Plugins/AmbiIRverb/docs/README.md)**: Plugin architecture and build instructions
...
1. **Load IR**: Use the IR Test view to load impulse responses
2. **Adjust Wet/Dry**: Control the reverb mix in real-time
3. **Monitor Latency**: View I/O latency for performance monitoring
4. **Test Presets**: Load `.ambipreset` files from `Resources/Presets/`
...
├── UI/               # Feature views (Record, IR, Transcode, IRTest, etc.)
├── Theme/            # Liquid Glass UI components
├── Plugins/          # Plugin source code
│   └── AmbiIRverb/   # JUCE plugin: hybrid convolution + algorithmic reverb
│       ├── Source/   # C++ plugin source (ConvoEngine, Spring, Plate, etc.)
│       ├── docs/     # Plugin documentation
│       └── Presets/  # Reverb presets (moved to Resources/Presets/)
├── Resources/        # Mic profiles and presets (includes AmbiIRverb presets)
...
### AmbiIRverb Integration
- ✅ Plugin source code integrated
- ✅ IR reverb audition UI (IRTestView)
- ✅ Preset files available
- ✅ Documentation included
- ⚠️ Plugin build integration (see `Plugins/AmbiIRverb/docs/BUILD.md`)
